// fn w_single_push_targets(wpawns: u64, empty: u64) -> u64 {
//     (wpawns << 8) & empty
// }
//
// fn w_double_push_targets(wpawns: u64, empty: u64) -> u64 {
...
// }
//
// fn b_single_push_targets(bpawns: u64, empty: u64) -> u64 {
//     (bpawns >> 8) & empty
// }
//
// fn b_double_push_targets(bpawns: u64, empty: u64) -> u64 {
