...
mod perft_tests {
    ...
    fn test_checkmate_detection() {
        ...
        assert_eq!(
            checkmates, 0,
            "Should be 0 checkmates at depth 1 in a checkmate position"
        );
    }
    ...
    fn test_perft_1() {
        ...
        eprintln!(
            "Depth 1: {} nodes ({} checkmates) in {:.3}s",
            nodes,
            checkmates,
    ...
    fn test_move_history_tracking() {
        ...
        assert_eq!(
            board.get_move_history().len(),
            0,
            "Move history should be empty after all undos"
        );
    }
}
